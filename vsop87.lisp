...
(defmacro build-vsop87-for-planet (planet)
	`(let ((vsop87-plist (vsop87-file-reader ,(concatenate 'string "vsop87/VSOP87A." (subseq planet 0 3)))))
		(defvar ,(read-from-string (format nil "*vsop-series-set-~a-x*" planet)) (getf vsop87-plist :x))
