...
(defmethod draw-2d (mfd screen-size)
	...
	(gl-raster-pos2d 0.5 0.5)
	(glut-bitmap-character *glut-bitmap-9-by-15* #\x)
	(glut-bitmap-character *glut-bitmap-9-by-15* #\y)
	(glut-bitmap-character *glut-bitmap-9-by-15* #\z))
