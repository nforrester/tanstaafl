		...
		(cond
			((check-depressed-keys #\8)
				(if (check-depressed-keys #\/)
					(command (getf thruster-groups :rcs-lin-down) 1)
					(command (getf thruster-groups :rcs-pitch-down) 1)))
			((check-depressed-keys #\2)
				(if (check-depressed-keys #\/)
					(commancommand (getf thruster-groups :rcs-lin-up) 1)
					(command (getf thruster-groups :rcs-pitch-up) 1)))
			((check-depressed-keys #\4)
				(command (getf thruster-groups :rcs-roll-port) 1))
			((check-depressed-keys #\6)
				(if (check-depressed-keys #\/)
					(command (getf thruster-groups :rcs-lin-fore) 1)
					(command (getf thruster-groups :rcs-roll-starboard) 1)))
			((check-depressed-keys #\9)
				(if (check-depressed-keys #\/)
					(command (getf thruster-groups :rcs-lin-aft) 1)))
			((check-depressed-keys #\1)
				(if (check-depressed-keys #\/)
					(command (getf thruster-groups :rcs-lin-port) 1)
					(command (getf thruster-groups :rcs-yaw-port) 1)))
			((check-depressed-keys #\3)
				(if (check-depressed-keys #\/)
					(command (getf thruster-groups :rcs-lin-starboard) 1)
					(command (getf thruster-groups :rcs-yaw-starboard) 1)))
